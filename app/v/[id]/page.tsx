...
export default async function Video({ params }: PageProps) {
	...
	const jsonLd = {
        ...
        url: `https://dientotramerame.pages.dev/v/${file.filecode}#${file.title}`,
